...
\p{2} Let $V$ be a finite dimensional complex vector space and $T:V \to V$ be a linear transformation. Let $p(x)$ denote the characteristic polynomial of $T$, and $m(x)$ denote the minimal polynomial of $T$. Find a necessary and sufficient condition on the Jordan Normal Form of $T$ for $p(x) = m(x)$.
\begin{proof}

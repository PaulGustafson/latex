...
\nc{\makeBase}{
      % left loop
       \draw[postaction={decorate}]  \mv -- ({\leftX - \loopR}, \pY) node[pos=.5,below]{$k$};
       \draw[postaction={decorate}]   ({\leftX + \loopR}, \pY) -- \mv  node[pos=.5,right]{$k$};
       
       % left leg
       \draw[postaction={decorate}]  \mv -- (\leftX, \pY) node[pos=.5,above]{$l$};

       % new right loop and leg
       \draw[postaction={decorate}]  \mv -- ({\leftX - 4*\loopR}, \pY) node[pos=.5,left]{$g$};

       \draw[postaction={decorate}]   ({\leftX - 2*\loopR}, \pY) -- \mv node[pos=.5,right]{$g$};
 
       % right leg
       \draw[postaction={decorate}]  \mv -- ({\leftX - 3*\loopR}, \pY) node[pos=.5, above]{$h$};       
}
...
\nc{\makeBraid}{
     ...
     \makeBase
       ...
       % right loop
       \draw[very thick, domain=0:180]      plot ({2*\loopR*cos(\x) + \leftX}, {2*\loopR*sin(\x) + \pY});
       \draw[very thick, domain=0:180]      plot ({4*\loopR*cos(\x) + \leftX}, {4*\loopR*sin(\x) + \pY});
       \draw[very thick, domain=180:360]      plot ({\loopR*cos(\x) + \leftX + 3*\loopR}, {\loopR*sin(\x) + \pY});
       
       %\right leg
       \draw[very thick, domain=0:180]      plot ({3*\loopR*cos(\x) + \leftX}, {3*\loopR*sin(\x) + \pY});
...
\nc{\makeBraidTwo}{
     ...
     \makeBase
       ...
       % left loop
       \draw[very thick, domain=0:180]      plot ({\loopR*cos(\x) + \leftX}, {3*\loopR*sin(\x) + \pY});

       % right loop
       \draw[very thick, domain=0:180]      plot ({2*\loopR*cos(\x) + \leftX}, {3*\loopR*sin(\x) + \pY});
       \draw[very thick, domain=0:180]      plot ({4*\loopR*cos(\x) + \leftX}, {3*\loopR*sin(\x) + \pY});
       \draw[very thick, domain=180:360]      plot ({\loopR*cos(\x) + \leftX + 3*\loopR}, {\loopR*sin(\x) + \pY});
...
\begin{tabular}{|c|c|}
  ...
  %Braid 1
    ...
    mark=at position 0.5 with {\arrow{>}}}
       ...
       % left loop
       \draw[postaction={decorate}]  \mv -- ({\leftX - \loopR}, \pY) node[pos=.5,below]{$g$};
       \draw[very thick, domain=0:180]      plot ({\loopR*cos(\x) + \leftX}, {\loopR*sin(\x) + \pY});
       \draw[postaction={decorate}]   ({\leftX + \loopR}, \pY) -- \mv  node[pos=.5,right]{$g$};
       
       % left leg
       \draw[postaction={decorate}]  \mv -- (\leftX, \pY) node[pos=.5,above]{$h$};

       % right loop
       \draw[postaction={decorate}]  \mv -- ({\rightX - \loopR}, \pY) node[pos=.5,left]{$k$};
       \draw[very thick, domain=0:180]      plot ({\loopR*cos(\x) + \rightX}, {\loopR*sin(\x) + \pY});
       \draw[postaction={decorate}]   ({\rightX + \loopR}, \pY) -- \mv  node[pos=.5,below]{$k$};
...
&
  ...
  %Braid 2
    ...
    mark=at position 0.5 with {\arrow{>}}}
      ...
      % TODO: calculate tangent lines maybe

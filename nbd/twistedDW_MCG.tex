...
&
  ...
  % Drag 2
    ...
    mark=at position 0.5 with {\arrow{>}}}
      ...
      %graph edges
      \draw[postaction={decorate}]   \mv -- \boundaryComponent node[pos=.5,sloped,below]{$k$};
      \draw[postaction={decorate}]   \rv -- \revertex node[pos=.5,sloped,above]{$h$};
      \draw[postaction={decorate}]   \rv -- (\rex, \dby) node[pos=.5,sloped,below]{$p$};
      \draw[postaction={decorate}]   \uv -- \rv  node[pos=.5,sloped,above]{$ph$};
      \draw[postaction={decorate}]   \mv -- \uv node[pos=.5,left]{$ghp$};
      \draw[postaction={decorate}]   \uv -- \mtop node[pos=.5,left]{$g$};
      \draw[postaction={decorate}]   \lev -- \mv node[pos=.5,sloped,above]{$h$};
      \draw[postaction={decorate}]   (0,\dby) -- \mv node[pos=.5,left]{$q$};

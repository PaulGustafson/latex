...
%% Definitions
    ...
    % outgoing edge
    \nc{\outEdge}{\draw[postaction={decorate}]  (0, 0) -- \lb node[pos=.5, right]{$hgh^{-1}$};}
...
\begin{figure}
    ...
    mark=at position 0.5 with {\arrow{>}}}
        ...
        \draw[postaction={decorate}]   \rb -- (0.75, 0.433) node[pos=.5,sloped,above]{$h$};
        \draw[postaction={decorate}]   \rb -- \mtop node[pos=.5,left]{$g$};
        \draw[postaction={decorate}]  (-0.75, 0.433) -- \lb node[pos=.5,sloped,above]{$h$};
        \draw[postaction={decorate}]  \lb -- \rb node[pos=.5,sloped,above]{$hg$};
        \outEdge
...
\begin{figure}
    ...
    mark=at position 0.5 with {\arrow{>}}}
        ...
        % new g
        \draw[postaction={decorate}]  \rb -- \rcut
...
\begin{figure}
    ...
    mark=at position 0.5 with {\arrow{>}}}
        ...
        \draw[postaction={decorate}]  (-0.75, 0.433) -- \lb node[pos=.5,sloped,above]{$h$};
        %\draw[postaction={decorate}]  \lb -- \rb node[pos=.5,sloped,above]{$hg$};
        \draw[postaction={decorate}]  \lb -- ({(\lbx + \rbx)/2} , {(\lby + \rby)/2})
        node[pos=.5,sloped,above]{$hg$};
        \draw[postaction={decorate}]  ({(\lbx + \rbx)/2} , {(\lby + \rby)/2}) -- \rb
        node[pos=.5,sloped,above]{$hg$};
        ...
        \draw  ({(\lbx + \rbx)/2} , {(\lby + \rby)/2}) --  ({(\lcutx + \mtopx)/2} , {(\lcuty + \mtopy)/2});
...
%% \centering
%%   \begin{tabular}{@{}cc@{}}
%%     \includegraphics[width=.48\textwidth]{1.jpeg} &
%%     \includegraphics[width=.48\textwidth]{2.jpeg} \\
%%     \includegraphics[width=.48\textwidth]{3.jpeg} &
%%     \includegraphics[width=.48\textwidth]{4.jpeg} \\
%%   \end{tabular}
%%   \caption{First type of Dehn twist}
%%   \label{fig:dehn1}
%% \end{figure}
...
%% \centering
%%   \begin{tabular}{@{}cc@{}}
%%     \includegraphics[width=.48\textwidth]{5.jpeg} &
%%     \includegraphics[width=.48\textwidth]{7.jpeg} \\
%%     \includegraphics[width=.48\textwidth]{8.jpeg} &
%%     \includegraphics[width=.48\textwidth]{9.jpeg} \\
%%   \end{tabular}

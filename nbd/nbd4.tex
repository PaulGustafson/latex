...
Given the fact that the braid group representations associated to $D^\omega(G)$ are also finite \cite{erw}, it should not be too much 
of a stretch to prove that mapping class group representations associated to $D^\omega(G)$ for \emph{any} surface are finite.  

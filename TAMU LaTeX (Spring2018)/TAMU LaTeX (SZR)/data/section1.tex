...
The dynamics of two dimensional topological phases of matter can be modeled usinng the theory of fusion categories. A fusion category is a rigid semisimple linear monoidal category with only finitely many isomorphism classes of simple objects \cite{etingofTensor}.  Each anyon type corresponds to an isomorphism class of simple objects.  A spherical fusion category is a fusion category equipped with a pivotal structure satisfying the spherical property \cite{etingofTensor}.  Sphericality is a technical property required for the uniqueness of the categorical trace (or, equivalently, the categorical dimension).

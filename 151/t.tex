...
\item[\textbf{1. }] (3 points) Find the derivative of the function $f(x) = x \sin(x)$.

\vskip 2in

\item[\textbf{2. }](4 points) Calculate $f'(0)$ where $\displaystyle f(x) = \frac{2 x^2 - 3}{x - 1}$.
 
\vskip 2in

\item[\textbf{3. }] (3 points) Find the equation of the tangent line to the graph of $y = \sqrt{1 - x^2}$ at the point $(0,1)$.

...
\item[\textbf{1. }] (3 points) Use the Fundamental Theorem of Calculus to find $g'(x)$ if $\displaystyle g(x) = \int_0^{x^2} e^{\sin(t)} \, dt$.
\vskip 2in

\item[\textbf{2. }] (3 points) Evaluate $\displaystyle \int_0^1 \frac{8}{x^2 + 1} \, dx$

\vskip 2in

\item[\textbf{3. }] (4 points) Calculate $\displaystyle \int \frac{3 + \sqrt{x} + x}{x^2} \, dx$.

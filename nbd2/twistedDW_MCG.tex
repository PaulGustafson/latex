...
The result of the first type of Dehn twist on the relevant part of the fundamental polygon is shown in Table 1 \ref{fig:tikzTwist1_1}.  First, every element of the spanning set $S$ is  to a colored graph of the type shown in the upper left figure.  

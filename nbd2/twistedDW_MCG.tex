...
the TVBW-representation of $\MCG(\Sigma)$ associated to $\mathcal A$ is isomorphic to the representation associated to $\mathcal B$.
\end{prop}
\begin{proof}
Let $F: \mathcal A \to \mathcal B$ be an equivalence of monoidal categories.
\end{proof}

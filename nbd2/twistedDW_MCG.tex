...
\end{aligned}
\end{equation}
where $\ev_X \colon X \otimes  \stX \to \one$ is the evaluation morphism.
...
\end{prop}
\begin{proof}
Let $F : \A \to \B$ be an equivalence of monoidal categories. I claim that $F$ induces an isomorphism $\overline{F}: H_A \to H_B$.    To see this, we need to check that $F$ preserves
\end{proof}

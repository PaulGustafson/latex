...
Thus, the representation space $H$ has a finite spanning set $S$ consisting of colored graphs $\Gamma$ with one vertex $v$ and edges $e_1, \ldots, e_{2g}$ corresponding to the standard generators of $\pi_1(M,v)$ such that the edge labels $V(e_i)$ 

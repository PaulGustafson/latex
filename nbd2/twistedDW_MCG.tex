...
will use notation $X_i$ for a representative of isomorphism class $i$.
...
\begin{defn}
The representation space $\Hs(\Si, \VV)$ associated to a closed, oriented surface $M$ by a spherical fusion category $\mathcal A$ is the quotient space
 $$

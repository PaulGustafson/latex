...
\begin{abstract}
We show that any twisted Dijkgraaf-Witten representation of a mapping class group of an orientable, compact surface with boundary has finite image. This generalizes work of Etingof, Rowell and Witherspoon showing that the braid group images are finite \cite{erw}.  In particular, we answer a question asked by Etingof, Rowell and Witherspoon in the affirmative.
\end{abstract}

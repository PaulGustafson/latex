...
Less is known about the more general mapping class group conjecture.  Wright has shown that, for any closed surface, the mapping class group representations associated to $U_qsl(2)$ at level $4$ have finite image \cite{gw}.  Funar proved that, for closed surfaces of genus $g \ge 2$, the mapping class group representations associated $SU(2)$ and $SO(3)$ are infinite for all sufficiently large levels \cite{funar}.
